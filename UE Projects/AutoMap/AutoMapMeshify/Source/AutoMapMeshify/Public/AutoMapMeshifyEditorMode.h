...
#include "AutoMapMeshifyEditorMode.generated.h"
 ...
 */
UCLASS()
class UAutoMapMeshifyEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_AutoMapMeshifyEditorModeId;

	static FString MeshCoverterToolName;

	UAutoMapMeshifyEditorMode();
	virtual ~UAutoMapMeshifyEditorMode();
