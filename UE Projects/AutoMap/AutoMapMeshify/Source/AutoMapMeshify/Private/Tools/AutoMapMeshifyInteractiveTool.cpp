...
#include "AutoMapMeshifyInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UAutoMapMeshifyInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UAutoMapMeshifyInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UAutoMapMeshifyInteractiveTool* NewTool = NewObject<UAutoMapMeshifyInteractiveTool>(SceneState.ToolManager);
...
UAutoMapMeshifyInteractiveToolProperties::UAutoMapMeshifyInteractiveToolProperties()
{
...
void UAutoMapMeshifyInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UAutoMapMeshifyInteractiveTool::Setup()
{
	...
	Properties = NewObject<UAutoMapMeshifyInteractiveToolProperties>(this, "Measurement");
...
void UAutoMapMeshifyInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UAutoMapMeshifyInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UAutoMapMeshifyInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UAutoMapMeshifyInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UAutoMapMeshifyInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UAutoMapMeshifyInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UAutoMapMeshifyInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UAutoMapMeshifyInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UAutoMapMeshifyInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
