...
#include "AutoMapMeshifyInteractiveTool.generated.h"


/**
 * Builder for UAutoMapMeshifyInteractiveTool
 */
UCLASS()
class AUTOMAPMESHIFY_API UAutoMapMeshifyInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UAutoMapMeshifyInteractiveTool
 */
UCLASS(Transient)
class AUTOMAPMESHIFY_API UAutoMapMeshifyInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UAutoMapMeshifyInteractiveToolProperties();
...
/**
 * UAutoMapMeshifyInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class AUTOMAPMESHIFY_API UAutoMapMeshifyInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UAutoMapMeshifyInteractiveToolProperties> Properties;
